...
public class InvoiceConsumerConfig {
    ...
    @Autowired
    public InvoiceConsumerConfig(Configs configs) {
        this.configs = configs;
    }

    public Map<String, Object> consumerConfig() {
        Map<String, Object> consumerProps = new HashMap<>();
        consumerProps.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, configs.getKafkaServerURL());
    ...
    public KafkaListenerContainerFactory<
            ConcurrentMessageListenerContainer<String, String>> concurrentListenerFactory() {
